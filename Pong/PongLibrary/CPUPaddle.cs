...
namespace PongLibrary
{
    ...
    public class CPUPaddle
    {
        ...
        public CPUPaddle(int paddleWidth, int paddleHeight, int screenWidth, int screenHeight, int speed, Ball ball, bool leftSide)
        {
            this.speed = speed;
        ...
        public CPUPaddle(int pw, int ph, int sw, int sh, int speed, Ball b, Rectangle padBox)
        {
            this.speed = speed;
